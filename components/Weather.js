...
export default function Weather({ weatherData, fetchWeatherData }) {
    ...
    let textColor = backgroundImage !== sunny ? '#a3411d' : '#385c3f'
    
    return (
        <View style={styles.container}>
            <StatusBar backgroundColor='#bdada8' />
            <ImageBackground 
            ...
            >
                ...
                <View style={styles.extraInfo}>
                    ...
                    <View style={styles.info}>
                        <Text style={{ fontSize: 22, color: '#bdada8' }}>Humidity</Text>
                        <Text style={{ fontSize: 22, color: '#bdada8' }}>{humidity} %</Text>
                    </View>

                    <View style={styles.info}>
                        <Text style={{ fontSize: 22, color: '#bdada8' }}>Wind Speed</Text>
                        <Text style={{ fontSize: 22, color: '#bdada8' }}>{speed} m/s</Text>
                    </View>
